...
constructDispatch
    (
        Nucleus_Media_Plugin_Metal_VideoSystem_Class *dispatch
    )
    ...
    )
{
    ...
    status = Nucleus_Media_Plugin_Metal_VideoSystem_getType(&type);
...
Nucleus_DefineDefaultCreate(Nucleus_Media_Plugin_Metal_VideoSystem)
